...
export function Titlebar() {
  ...
  return (
    <div
      ...
      className="h-8 w-full flex-shrink-0 flex items-center justify-between select-none bg-zinc-950 border-b border-zinc-900/80 z-50"
    >
      ...
      <div className="flex items-center h-full">
        <button
          ...
          tabIndex={-1}
          className="h-full w-11 flex items-center justify-center text-zinc-500 hover:text-zinc-200 hover:bg-zinc-800 transition-colors"
        >
          <Minus size={13} />
        </button>
        <button
        ...
        <button
          onClick={() => win.close()}
          tabIndex={-1}
          className="h-full w-11 flex items-center justify-center text-zinc-500 hover:text-white hover:bg-red-500 transition-colors"
        >
          <X size={13} />
        </button>
      </div>
